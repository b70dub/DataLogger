 ...
 *
 * LCD5110 is connectecd with the the following configuration:
 *
 * LED --> Vcc
 * SCK --> B15  (PIN26)
 * DN<MOSI> --> (PIN24)
...
//Define pins
#define SCE_5110  LATBbits.LATB7
#define RESET_5110 LATBbits.LATB2
#define DC_5110 LATBbits.LATB3
...
// Configure Peripheral Pin Select (PPS) for the SPI1 module
    // as stated in SECTION 11.3 of the datasheet
    RPB13Rbits.RPB13R = 4;        //RPB13R is SD02

    CTMUCONbits.ON = 0;
    //Open SPI for Nokia LCD on SPI2
    SpiChnOpen(2, SPI_OPEN_MSTEN|SPI_OPEN_MODE8|SPI_OPEN_ON, SYS_FREQ/200000);

    //Set up pins for SCE (B7), RST (B2), DC (B3)
    TRISBbits.TRISB7= 0;
    TRISBbits.TRISB2= 0;
    TRISBbits.TRISB3= 0;
...
void LCD5110_init(void)
{
    ...
    delay_ms(20); // Delay 20ms for stabilization
    RESET_5110 = 1;
