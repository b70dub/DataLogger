...
#define MMA8452Q_ADDR_1       0x1D // A '<< 1' is needed.  I add the '<< 1' in the helper functions.
#define MMA8452Q_ADDR_2       0x1C // A '<< 1' is needed.  I add the '<< 1' in the helper functions.
...
#define maxG                FS_4G // what scale to get G readings

//MMA8452FC Sensitivity 
...
/******************************************************************************
* MMA8452FC Global variables and constants
******************************************************************************/
